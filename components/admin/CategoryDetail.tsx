            ...
            <tbody>
              ...
              {categories.map((item, idx) => (
                <tr key={idx} className="text-pink-300">
                  ...
                  <td className="flex items-center gap-2 flex-wrap h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-pink-100 stroke-slate-500 text-slate-500 first-letter:uppercase ">
